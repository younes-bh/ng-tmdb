angular.module("app")
  .controller("topRatedCtrl", function(serviceMovies){
    var self = this;
    var url = "http://api.themoviedb.org/3/movie/top_rated?api_key=5192eb6331a3db50b6b388ae8941edc6&language=fr-FR&page=";
    self.currentPage = 1;
